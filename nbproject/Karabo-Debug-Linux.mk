...
${OBJECTDIR}/src/CameraImageSource.o: src/CameraImageSource.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CameraImageSource.o src/CameraImageSource.cc

${OBJECTDIR}/src/ImageSource.o: src/ImageSource.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ImageSource.o src/ImageSource.cc

${OBJECTDIR}/src/Scene.o: src/Scene.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Scene.o src/Scene.cc
...
${TESTDIR}/src/tests/ImageSourceTest.o: src/tests/ImageSourceTest.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ImageSourceTest.o src/tests/ImageSourceTest.cc


${TESTDIR}/src/tests/test_runner.o: src/tests/test_runner.cc 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/test_runner.o src/tests/test_runner.cc
...
${OBJECTDIR}/src/CameraImageSource_nomain.o: ${OBJECTDIR}/src/CameraImageSource.o src/CameraImageSource.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CameraImageSource_nomain.o src/CameraImageSource.cc;\
	else  \
...
${OBJECTDIR}/src/ImageSource_nomain.o: ${OBJECTDIR}/src/ImageSource.o src/ImageSource.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ImageSource_nomain.o src/ImageSource.cc;\
	else  \
...
${OBJECTDIR}/src/Scene_nomain.o: ${OBJECTDIR}/src/Scene.o src/Scene.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I${KARABO}/include -I${KARABO}/extern/include -I${KARABO}/extern/include/opencv4 `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Scene_nomain.o src/Scene.cc;\
	else  \
