...
namespace karabo {
    ...
    std::string ImageSource::scene() {
        ...
        output << ""
            ...
            "	<svg:rect height=\"27\" krb:class=\"Label\" krb:font=\"Ubuntu,11,-1,5,75,0,0,0,0,0\" krb:foreground=\"#000000\" krb:frameWidth=\"0\" krb:text=\"DeviceID\" width=\"74\" x=\"64\" y=\"31\"/>"
            "	<svg:rect expression=\"x.split('/')[-1]\" height=\"27\" krb:class=\"DisplayComponent\" krb:keys=\"" << instanceId << ".deviceId\" krb:widget=\"Evaluator\" width=\"146\" x=\"140\" y=\"31\"/>"
            ...
            "			<svg:rect height=\"27\" krb:class=\"Label\" krb:font=\"Ubuntu,11,-1,5,50,0,0,0,0,0\" krb:foreground=\"#000000\" krb:frameWidth=\"0\" krb:text=\"Exposure Time\" width=\"110\" x=\"456\" y=\"371\"/>"
            "		</svg:g>"
            "		<svg:g krb:class=\"BoxLayout\" krb:direction=\"0\" krb:height=\"52\" krb:width=\"330\" krb:x=\"465\" krb:y=\"133\">"
            "			<svg:rect height=\"28\" krb:class=\"Label\" krb:font=\"Noto Sans,11,-1,5,50,0,0,0,0,0\" krb:foreground=\"#000000\" krb:frameWidth=\"0\" krb:text=\"\" width=\"10\" x=\"0\" y=\"0\"/>"
            ...
            "		</svg:g>"
            "		<svg:rect height=\"30\" krb:class=\"DisplayComponent\" krb:keys=\"" << instanceId << ".state\" krb:staticText=\"\" krb:widget=\"DisplayStateColor\" width=\"292\" x=\"524\" y=\"48\"/>"
            "		<svg:rect height=\"30\" krb:class=\"DisplayComponent\" krb:keys=\"" << instanceId << ".state\" krb:widget=\"DisplayLabel\" width=\"288\" x=\"524\" y=\"48\"/>"
